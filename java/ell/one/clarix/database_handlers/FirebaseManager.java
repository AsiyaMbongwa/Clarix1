...
import ell.one.clarix.activities.IntroActivity;
                            ...
                            user.updateProfile(profileUpdates)
                                    .addOnCompleteListener(profileTask -> {
                                        if (profileTask.isSuccessful()) {
                                            Log.d(TAG, "registerUser: Display name updated");
                                            ...
                                            Log.e(TAG, "registerUser: Failed to update display name", profileTask.getException());
                                        }
                                    });
                        } else {
